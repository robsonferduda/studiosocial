<div style="clear:both; margin-top: 20px;">
    <div style="width: 85%; float: left;">
        <h6 style="margin-bottom: 0px; padding-bottom: 5px; margin-top: 20px; font-size: 17px; border-bottom: 3px solid #b5b4b4;">Relatório de Sentimentos</h6>
        <p style="color: #eb8e06; margin: 0;">Período: {{ $dt_inicial }} à {{ $dt_final }}</p>
    </div>
