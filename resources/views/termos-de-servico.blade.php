        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="card-title ml-2"><i class="fa fa-book"></i> Studio Social - Termos de Serviço</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="px-3">
                        <h5>Esta política de Termos de Uso é válida a partir de outubro de 2021.</h5> 
                        <p>Studio Social, pessoa jurídica de direito privado descreve, através deste documento, as regras de uso do site http://studiosocial.ga/ e qualquer outro site, loja ou aplicativo operado pelo proprietário.</p>
                        ...
                        <li>
                            ...
                            <p>A utilização deste website acarreta a adesão aos presentes Termos de Uso e a versão mais atualizada da Política de Privacidade de Studio Social.</p>
                        </li>
                        <li>
                            <h4>Seção 3 - Condições de acesso</h4>
                            <p>Em geral, o acesso ao website da Studio Social possui caráter gratuito e não exige prévia inscrição ou registro.</p>
                            ...
                            <p>Partes deste website oferecem ao usuário a opção de publicar comentários em determinadas áreas. Studio Social não consente com a publicação de conteúdos que tenham natureza discriminatória, ofensiva ou ilícita, ou ainda infrinjam direitos de autor ou quaisquer outros direitos de terceiros.</p>
                            <p>A publicação de quaisquer conteúdos pelo usuário deste website, incluindo mensagens e comentários, implica em licença não-exclusiva, irrevogável e irretratável, para sua utilização, reprodução e publicação pela Studio Social no seu website, plataformas e aplicações de internet, ou ainda em outras plataformas, sem qualquer restrição ou limitação.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <p>Todos os elementos de Studio Social são de propriedade intelectual da mesma ou de seus licenciados. Estes Termos ou a utilização do website não concede a você qualquer licença ou direito de uso dos direitos de propriedade intelectual da Studio Social ou de terceiros.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <p>O website no todo ou em cada uma das suas seções, pode ser encerrado, suspenso ou interrompido unilateralmente por Studio Social, a qualquer momento e sem necessidade de prévio aviso.</p>
                        </li>
                        <li>
                            <h4>Seção 8 - Dados pessoais</h4>
                            <p>Durante a utilização deste website, certos dados pessoais serão coletados e tratados por Studio Social e/ou pelos Parceiros. As regras relacionadas ao tratamento de dados pessoais de Studio Social estão estipuladas na Política de Privacidade.</p>
                        </li>
                        <li>
                            <h4>Seção 9 - Contato</h4>
                            <p>Caso você tenha qualquer dúvida sobre os Termos de Uso, por favor, entre em contato pelo e-mail robsonferduda@gmail.com.</p>
                        </li>
                        </ul>
                    </div>
                    <div class="center mb-4 mt-3">
                        <a class="mr-5 mb-3" href="{{ url('/') }}">Voltar para o início</a>
                    </div>
                </div>
            </div>
        </div>
