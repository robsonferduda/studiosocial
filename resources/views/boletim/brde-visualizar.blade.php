                ...
                <div class="card-header" style="padding-top: 0px;">
                    <div class="row">
                        @if($boletim->cliente->fl_banner == "y")
                            <img style="border-radius: 0px; border-top-left-radius: 5px; border-top-right-radius: 5px;" src="{{ asset('img/banner/'.$boletim->cliente->logo ) }}">
                        @else
                            <div class="col-md-6">
                ...
                <div class="card-body">
                    ...
                    @if($noticia->uf != $uf)
                        <div class="px-3 py-2 mb-3" style="">
                            <p style="color: #2196f3; font-size: 20px !important; text-transform: uppercase; border-bottom: 1px solid #2196f3;"><i class="fa fa-newspaper-o" aria-hidden="true"></i> {{ $uf_extenso }}</p>
                        @php
                            $flag_uf = true;
                        @endphp
                    @endif
                    ...
                    @if($noticia->clipagem != $tipo or($noticia->clipagem == $tipo and $noticia->uf != $uf))
                                ...
                                @elseif($noticia->clipagem == 'web')
                                    ...
                                    <div style="border-bottom: 1px solid #e3e3e3; margin-bottom: 10px; padding-bottom: 10px;">
                                        <p style="margin-bottom: 0px;"><strong>{{ $noticia->titulo }}</strong></p>
                                        <p style="margin-bottom: 0px;"><strong>Data:</strong> {{ date('d/m/Y', strtotime($noticia->data)) }}</p>
