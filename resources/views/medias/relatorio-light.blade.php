...
@section('content')
    ...
    <div style="margin-top: 20px;">
        <div style="width: 84%; float: left;" >
            <br />
            <h6 style="margin-bottom: 0px; padding-bottom: 5px; margin-top: 10px; font-size: 17px; border-bottom: 3px solid #b5b4b4;">{{ $nome }}</h6>
            <p style="color: #eb8e06; margin: 0;margin-top: 10px"><strong>Período: {{ $dt_inicial }} à {{ $dt_final }}</strong></p>
            <p style="color: #eb8e06; margin: 0;">{{ session('cliente')['nome'] }}</p>
            <p style="color: #eb8e06; margin: 0;">FORAM COLETADOS {{ count($dados) }} POSTS</p>
        </div>
