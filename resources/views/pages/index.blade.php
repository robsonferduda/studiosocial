                                    ...
                                    @php
                                        ...
                                        if($page->fbPagesPost) {
                                            foreach ($page->fbPagesPost as $post) {
                                                $comments_count +=  $post->fbPagePostComment->count();                                              
                                            }    
                                        }
                                    @endphp

                                    <p><a href="{{ url('facebook-paginas/monitoramento/'.$page->id) }}">{{ $page->fb_pages_post_count + $comments_count }} Postagens + Comentários</a></p>
                                </div>
                                <div class="col-md-9">
