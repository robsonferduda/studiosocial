...
f = open ("/var/www/html/studiosocial/storage/app/hashtag/files/"+file_name+".json", "r")
...
if tipo == 'imagem' :
    if len(wordcloud_words) > 0:
        ...
        wordcloud.to_file("/var/www/html/studiosocial/storage/app/hashtag/files/"+file_name+".png")
