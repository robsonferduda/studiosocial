...
class ProcessamentoController extends Controller
{
    ...
    public function baixar($pasta)
    {
        ...
        $chaves_busca = array('gás',
                                'sc gás',
                                'veículo o gás natural',
                                'gás que você precisa é natural',
                                'com combustível pintura',
                                'segura para sua residência comércio',
                                'vem mudando a vida de muitos motoristas',
                                'pela economia consciente o gás natural',
                                'consciência ambiental o gás',
                                'mais economia você tem mais segurança',
                                'gás natural',      
                                'gás que você precisa',        
                                'motoristas catarinenses',       
                                'santa catarina',        
