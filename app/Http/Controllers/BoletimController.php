...
class BoletimController extends Controller
{
    ...
    {
        $boletins = Boletim::whereIn('id_cliente',[30,443,452])->paginate(50)->orderBy('data','DESC')->get();
    ...
    public function enviar($id)
    {
        ...
        if($boletim->id_cliente == 452){
            ...
            $lista_email = array(
                ...
                array('nome' => 'Eduardo', 'email' => 'eduardo.cotta@zurichairportbrasil.com'),
                ...
                array('nome' => 'Marcelo Fleury', 'email' => 'marcelo.fleury@zurichairportbrasil.com'),
            ...
            $lista_email = array(
                            ...
                            array('nome' => 'Gisele Alencar', 'email' => 'gisele.alencar@zurichairportbrasil.com'),
                            ...
                            array('nome' => 'Mirna', 'email' => 'mirna.moulin@zurichairportbrasil.com'),
