...
f = open ("/home/socialstudio/public_html/storage/app/hashtag/files/cliente-"+cliente+"-hashtag.json", "r")
...
if tipo == 'imagem' :
    if len(wordcloud_words) > 0:
        ...
        wordcloud.to_file("/home/socialstudio/public_html/storage/app/hashtag/files/images/cliente_"+cliente+"_hashtag.png")
print('END')