(function ($) {
  ...
  $.fn.inputTags.defaults = {
      ...
      errors: {
          empty: 'Atenção, você não pode adicionar uma expressão vazia.',
          minLength: 'Atenção, sua expressão deve ter no mínimo %s caracteres.',
          maxLength: 'Atenção, sua expressão não deve passar de %s caracteres.',
          max: 'Atenção, o número de expressões não deve passar de %s.',
          email: 'Attention, l\'adresse email que vous avez entré n\'est pas valide',
          exists: 'Atenção, a expressão já existe na lista !',
